...
private:
    string m_strVSFuncName;
    string m_strHSFuncName;
    string m_strDSFuncName;
    string m_strGSFuncName;
    string m_strPSFuncName;
...
public:
    ...
    string GetVSName() { return m_strVSFuncName; }
    string GetHSName() { return m_strHSFuncName; }
    string GetDSName() { return m_strDSFuncName; }
    string GetGSName() { return m_strGSFuncName; }
    string GetPSName() { return m_strPSFuncName; }

    string GetVSPath() { return m_strVSPath; }
    string GetHSPath() { return m_strHSPath; }
    string GetDSPath() { return m_strDSPath; }
    string GetGSPath() { return m_strGSPath; }
    string GetPSPath() { return m_strPSPath; }
